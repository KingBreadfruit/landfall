...
// ---------------------------------------------------------------------------
// Clean slate. All fabricated demo data has been cleared out — add real
// entries through the app. The only thing kept is the single shelter venue
// (Portmore HS) with empty inventory/roster, since the hackathon uses one
// shelter and it's the drop-off point for runs.
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Recognition: the current user starts at zero; no fabricated leaderboard.
// ---------------------------------------------------------------------------
